...
<div class="columns is-variable is-3">
      ...
      <div class="menu wrapper">
        ...
        <ul class="menu-list">
          <li>
            <a>Admins</a>
              <ul>
              <li><a href="admin_add.php" class="is-active">Add admin</a></li>
  ...
  <div class="column"  style="padding: 30px">
    ...
    <h1 class="title has-text-black is-2">Enter admin details: </h1><br>

    <form name='myForm' action="confirmadmin.php?action=add" onsubmit="return validateForm()" method='post'>
